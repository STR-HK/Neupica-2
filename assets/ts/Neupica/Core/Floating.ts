...
declare global {
    interface Window {
        ...
        setFloat: (NeuApp: NeuApp) => void,
        delFloat: (NeuApp: NeuApp) => void,
        listFloat: () => Array<any>,
    }
}
...
class FloatManager {
    ...
    setFloat(NeuApp: NeuApp): void {
        ...
        window.FloatManager.floats[NeuApp.appCode] = FloatElement
        window.FloatManager.floatApps[NeuApp.appCode] = NeuApp
    ...
    delFloat(NeuApp) {
        document.querySelector('.FloatingPlace').removeChild(window.FloatManager.floats[NeuApp.appCode])
        delete window.FloatManager.floats[NeuApp.appCode]
        delete window.FloatManager.floatApps[NeuApp.appCode]
    ...
    listFloat() {
        return Object.values(window.FloatManager.floatApps)
    }
}
