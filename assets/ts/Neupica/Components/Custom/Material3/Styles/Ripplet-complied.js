...
function rippletComplied(_a, _options) {
...
rippletComplied.clear = function (targetElement, rippletContainerElement) {
    if (targetElement) {
...
rippletComplied.defaultOptions = defaultOptions;
rippletComplied._ripplets = target2container2ripplet;
var named = /*#__PURE__*/ Object.freeze({
    __proto__: null,
    defaultOptions: defaultOptions,
    'default': rippletComplied
});
Object.keys(named).forEach(function (name) { rippletComplied[name] = named[name]; });
//# sourceMappingURL=Ripplet-complied.js.map