...
export class ResultScreen extends NeuContainer {
    constructor(parent) {
        ...
        this.subtitle.data.Text = '당신은 성공적으로 범인을 잡았습니다'
        ...
        setInterval(function() {
            this.mss.data.Text = `${localStorage.getItem('before')} -> ${localStorage.getItem('after')}`
        ...
        this.Return.watchEvent('click', function() {
            ...
            checker.CloseButton.data.Text = 'CEL'
...
export class FailureScreen extends ResultScreen {
    constructor(parent) {
        ...
        this.icon.data.Text = 'report'
        this.title.data.Text = '실패하였습니다...'
        this.subtitle.data.Text = '당신이 지목한 범인은 진범이 아니었습니다'
    }
}